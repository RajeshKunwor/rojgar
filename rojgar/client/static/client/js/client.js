function ViewModel(){
    ...
    var s_url = $("#client_signup_form").attr("data-s-url");
    var d_url = $("#client_signup_form").attr("data-d-url");
    var m_url = $("#client_signup_form").attr("data-m-url");
    var data_post_url = $("#client_signup_form").attr("data-post-url");
...
//			self.selectedMunicipality(municipality)
	...
	self.save = function(){
        client_data = ko.toJSON({fullName: self.fullName,
